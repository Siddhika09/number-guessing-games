...
async function makeGuess() {
  ...
  // ✅ Add each guess with hint
  const li = document.createElement("li");

  if (data.result === "low") {
    li.innerText = "Your guess: " + num + " → Too low 🔼";
  }
  else if (data.result === "high") {
    li.innerText = "Your guess: " + num + " → Too high 🔽";
  }
  else {
    li.innerText = "Your guess: " + num + " → ✅ Correct!";
  }
